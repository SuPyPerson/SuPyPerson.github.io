...
||||||
"""
v__.Jogo.Curumim = Indio
kwarwp_main(vitollino=Jogo, medidas=STYLE, mapa=MAPA, indios=(Indio,), tela=c__.tela)
# _VIT_
from vitollino import Jogo as Vit
def caminha(self):
    self.direita()
    self.anda()

Vit.Curumim.executa = caminha
