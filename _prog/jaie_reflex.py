...
_SET0_ = {
    "script_name": "caderno_reflete", "script_div_id": "reflete_glo",
...
if __name__ == "__main__":
    Cenario().vai()
_SET1_ = {
    "script_name": "caderno_reflete", "script_div_id": "reflete_ent",
...
_SET2_ = {
    "script_name": "caderno_reflete", "script_div_id": "reflete_rev",
...
_SET3_ = {
    "script_name": "caderno_reflete", "script_div_id": "reflete_jog",
...
JOGO = Jogo(style=dict(height="450px", width="600px"), did="_jogo_")
exec(__use__("_reflete_rep"))  # importa o módulo Repensando o Storyboard
exec(__use__("_reflete_def"))
c = Cenario(2, 4).vai()
