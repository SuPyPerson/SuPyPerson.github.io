...
_SET1_ = {
    "script_name": "age-main.py", "script_div_id": "agente_main",
...
UmaGarrafa()
_SET2_ = {
    "script_name": "age-aventura.py", "script_div_id": "agente_aventura",
...
UmaGarrafa()
_SET3_ = {
    "script_name": "age-continua.py", "script_div_id": "agente_continua",
...
AventuraContinua()
_SET4_ = {
    "script_name": "age-partes.py", "script_div_id": "agente_partes",
...
AventuraPartes()
_SET5_ = {
    "script_name": "age-aprende.py", "script_div_id": "agente_aprende",
    "height": 250, "title": "A Aventura Termina", "show_scenario": False, "console_height": 45
}  # _SEC_
# document["_so0_"].remove()
# _VIT_
...
AventuraAprende()
_SET6_ = {
    "script_name": "age-termina.py", "script_div_id": "agente_termina",
    "height": 250, "title": "A Aventura Termina", "show_scenario": False, "console_height": 45
}  # _SEC_
# document["_so0_"].remove()
# _VIT_
