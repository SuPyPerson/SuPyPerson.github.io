...
_SET1_ = {
    "script_name": "caderno_recicla", "code_name": "rec-main.py", "script_div_id": "recicla_main",
...
UmaGarrafa()
_SET2_ = {
    "script_name": "caderno_recicla", "code_name": "rec-aventura.py", "script_div_id": "recicla_aventura",
...
UmaGarrafa()
_SET3_ = {
    "script_name": "caderno_recicla", "code_name": "rec-continua.py", "script_div_id": "recicla_continua",
...
AventuraContinua()
_SET4_ = {
    "script_name": "caderno_recicla", "code_name": "rec-termina.py", "script_div_id": "recicla_termina",
...
class AventuraTermina:
    def __init__(self):
        ...
        p.vai()
_SET5_ = {
    "script_name": "caderno_recicla", "code_name": "rec-extra.py", "script_div_id": "recicla_extra",
...
_SET6_ = {
    "script_name": "caderno_recicla", "code_name": "rec-complemento.py", "script_div_id": "recicla_complemento",
    "height": 250, "title": "A Aventura Complemento", "show_scenario": False, "console_height": 45
}  # _SEC_
# document["_so0_"].remove()
# _VIT_
"""Módulo rec.complemento"""
from vitollino import Cena, Texto, Jogo, Elemento
from cenario import Planilha, Paisagens
Jogo(style=dict(height="500px", width="650px"), did="_jogo_").z()
